...
def evict(cache_snapshot, obj):
    ...
    if len(sorted_keys) > 1:
       if heuristic_scores[sorted_keys[0]] == heuristic_scores[sorted_keys[1]] and insertion_times[sorted_keys[0]] >= insertion_times[sorted_keys[1]]:
           logging.fatal(f"ERROR: ({sorted_keys[0]}: {heuristic_scores[sorted_keys[0]]}, {insertion_times[sorted_keys[0]]}) ({sorted_keys[1]}: {heuristic_scores[sorted_keys[1]]}, {insertion_times[sorted_keys[1]]})")
