...
def update_after_hit(cache_snapshot, obj):
    ...
    meta['heuristic_fusion'] = INITIAL_HEURISTIC_FUSION_SCORE
...
def update_after_evict(cache_snapshot, obj, evicted_obj):
    ...
    for key in metadata:
        meta = metadata[key]
        meta['heuristic_fusion'] = INITIAL_HEURISTIC_FUSION_SCORE  # Recalibrate as needed
        meta['adaptive_resonance'] *= REDUCE_FACTOR  # Adjust as needed
        meta['temporal_distortion'] *= BOOST_FACTOR  # Update as needed
