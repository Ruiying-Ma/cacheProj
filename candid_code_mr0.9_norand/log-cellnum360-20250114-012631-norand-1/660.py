...
def evict(cache_snapshot, obj):
    ...
    # Evaluate combined score and find the object with the lowest score
    min_score = float('inf')
    candid_obj_key = None
    ...
    # Remove the entry from both the LRU and FIFO queues
...
def update_after_hit(cache_snapshot, obj):
    ...
    # Move the entry to the most-recently-used end of the LRU queue and the rear of the FIFO queue
    if key in lru_queue:
...
def update_after_insert(cache_snapshot, obj):
    ...
    # Place the object at the current pointer location, the most-recently-used end of the LRU queue, and the rear of the FIFO queue
    fifo_queue.append(key)
    lru_queue.append(key)
