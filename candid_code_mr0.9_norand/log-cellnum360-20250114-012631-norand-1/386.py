...
def evict(cache_snapshot, obj):
    ...
    for key in cache_snapshot.cache:
        ...
        hfs = heuristic_fusion_score[key]
        arl = adaptive_resonance_level[key]
        tdf = temporal_distortion_factor[key]
        score = (freq + hfs + arl) * tdf
...
def update_after_hit(cache_snapshot, obj):
    ...
    heuristic_fusion_score[key] = math.log(1 + access_frequency[key]) * adaptive_resonance_level[key]
...
def update_after_evict(cache_snapshot, obj, evicted_obj):
    ...
    for key in cache_snapshot.cache:
        ...
        temporal_distortion_factor[key] *= 1.01  # Slight adjustment